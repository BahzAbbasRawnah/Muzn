...
class DatabaseHelper {
  ...
  Future<int> updateUser(Map<String, dynamic> user) async {
    final db = await _databaseHelper.database;
    return await db.update('User', user, where: 'id = ?', whereArgs: [user['id']]);
  }
  ...
  Future<int> insertSchoolMosque(Map<String, dynamic> schoolMosque) async {
    final db = await _databaseHelper.database;
    return await db.insert('SchoolMosque', schoolMosque, conflictAlgorithm: ConflictAlgorithm.replace);
  }

  /// Get a school/mosque by ID
  Future<Map<String, dynamic>?> getSchoolMosqueById(int id) async {
    final db = await _databaseHelper.database;
    final result = await db.query('SchoolMosque', where: 'id = ?', whereArgs: [id]);
    return result.isNotEmpty ? result.first : null;
  }

  /// Get all schools/mosques
  Future<List<Map<String, dynamic>>> getAllSchoolMosques(int teacher_user_id) async {
    final db = await _databaseHelper.database;
...
Future<List<Map<String, dynamic>>> getAllSchoolMosquesWithCirclesCount(int teacherUserId) async {
  final db = await _databaseHelper.database;
  ...
  Future<int> updateSchoolMosque(Map<String, dynamic> schoolMosque) async {
    final db = await _databaseHelper.database;
    return await db.update('SchoolMosque', schoolMosque, where: 'id = ?', whereArgs: [schoolMosque['id']]);
  }
  ...
  Future<int> insertCirclesCategory(Map<String, dynamic> category) async {
    final db = await _databaseHelper.database;
    return await db.insert('CirclesCategory', category, conflictAlgorithm: ConflictAlgorithm.replace);
  }

  /// Get a circle category by ID
  Future<Map<String, dynamic>?> getCirclesCategoryById(int id) async {
    final db = await _databaseHelper.database;
    final result = await db.query('CirclesCategory', where: 'id = ?', whereArgs: [id]);
    return result.isNotEmpty ? result.first : null;
  }
  ...
  Future<int> updateCirclesCategory(Map<String, dynamic> category) async {
    final db = await _databaseHelper.database;
    return await db.update('CirclesCategory', category, where: 'id = ?', whereArgs: [category['id']]);
  }
  ...
  Future<int> insertCircle(Map<String, dynamic> circle) async {
    final db = await _databaseHelper.database;
    return await db.insert('Circle', circle, conflictAlgorithm: ConflictAlgorithm.replace);
  }
...
Future<List<Map<String, dynamic>>> getAllMosqueCircles(int schoolId) async {
  ...
  Future<int> updateCircle(Map<String, dynamic> circle) async {
    final db = await _databaseHelper.database;
    return await db.update('Circle', circle, where: 'id = ?', whereArgs: [circle['id']]);
  }
...
Future<int> insertStudent(Map<String, dynamic> student) async {
  final db = await _databaseHelper.database;
  return await db.insert('Student', student, conflictAlgorithm: ConflictAlgorithm.replace);
}
...
Future<List<Map<String, dynamic>>> getStudentsByTeacherId(int teacherId) async {
  final db = await _databaseHelper.database;
  return await db.query('Student', where: 'teacher_id = ?', whereArgs: [teacherId]);
}

/// Update a student
Future<int> updateStudent(Map<String, dynamic> student) async {
  final db = await _databaseHelper.database;
  return await db.update('Student', student, where: 'id = ?', whereArgs: [student['id']]);
}
...
Future<int> deleteStudent(int id) async {
  ...
  Future<int> insertCircleStudent(Map<String, dynamic> circleStudent) async {
    final db = await _databaseHelper.database;
    return await db.insert('CircleStudent', circleStudent, conflictAlgorithm: ConflictAlgorithm.replace);
  }
...
Future<Map<String, dynamic>?> getCircleWithStudentById(int circleId) async {
  ...
  final result = await db.rawQuery('''
    ...
    FROM Circle c
    LEFT JOIN CircleStudent cs ON c.id = cs.circle_id
    LEFT JOIN Student st ON cs.student_id = st.user_id
  ...
  Future<int> updateCircleStudent(Map<String, dynamic> circleStudent) async {
    final db = await _databaseHelper.database;
    return await db.update('CircleStudent', circleStudent, where: 'id = ?', whereArgs: [circleStudent['id']]);
  }
  ...
  Future<int> insertStudentProgress(Map<String, dynamic> progress) async {
    final db = await _databaseHelper.database;
    return await db.insert('StudentProgress', progress, conflictAlgorithm: ConflictAlgorithm.replace);
  }

  /// Get a student progress by ID
  Future<Map<String, dynamic>?> getStudentProgressById(int id) async {
    final db = await _databaseHelper.database;
    final result = await db.query('StudentProgress', where: 'id = ?', whereArgs: [id]);
    return result.isNotEmpty ? result.first : null;
  }
  ...
  Future<int> updateStudentProgress(Map<String, dynamic> progress) async {
    final db = await _databaseHelper.database;
    return await db.update('StudentProgress', progress, where: 'id = ?', whereArgs: [progress['id']]);
  }
  ...
  Future<int> insertHomeWork(Map<String, dynamic> homework) async {
    final db = await _databaseHelper.database;
    return await db.insert('HomeWork', homework, conflictAlgorithm: ConflictAlgorithm.replace);
  }
  ...
  Future<int> updateHomeWork(Map<String, dynamic> homework) async {
    final db = await _databaseHelper.database;
    return await db.update('HomeWork', homework, where: 'id = ?', whereArgs: [homework['id']]);
  }
  ...
  Future<int> insertDigitalLibrary(Map<String, dynamic> item) async {
    final db = await _databaseHelper.database;
    return await db.insert('DigitalLibrary', item, conflictAlgorithm: ConflictAlgorithm.replace);
  }

  /// Get a digital library item by ID
  Future<Map<String, dynamic>?> getDigitalLibraryById(int id) async {
    final db = await _databaseHelper.database;
    final result = await db.query('DigitalLibrary', where: 'id = ?', whereArgs: [id]);
    return result.isNotEmpty ? result.first : null;
  }
  ...
  Future<int> updateDigitalLibrary(Map<String, dynamic> item) async {
    final db = await _databaseHelper.database;
    return await db.update('DigitalLibrary', item, where: 'id = ?', whereArgs: [item['id']]);
  }
  ...
  Future<int> updateSettings(Map<String, dynamic> settings) async {
    final db = await _databaseHelper.database;
    return await db.update('Settings', settings, where: 'id = ?', whereArgs: [settings['id']]);
  }
