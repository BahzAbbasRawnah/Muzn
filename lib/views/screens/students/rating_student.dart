...
import 'package:muzn/views/widgets/succes_message.dart';
    ...
    context.read<StudentProgressBloc>().stream.listen((state) {
      if (state is StudentProgressAdded) {
        CustomSnackBar.showSuccess(
            context, 'inserted_successfully'.tr(context));
        ...
        CustomSnackBar.showFailed(context, 'inserted_failed'.tr(context));
      }
    });
  }
}
